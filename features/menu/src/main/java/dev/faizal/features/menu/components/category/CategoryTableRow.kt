            ...
            Row(
                ...
                androidx.compose.foundation.layout.Column(
                    ...
                    Surface(
                        ...
                        color = if (item.category.isActive) Color(0xFF4CAF50).copy(alpha = 0.12f)
                        else Color(0xFFFF9800).copy(alpha = 0.12f)
                    ) {
                        Text(
                            text = if (item.category.isActive) "Active" else "Inactive",
                            fontSize = 11.sp,
                ...
                Row(
                    ...
                    IconButton(onClick = onDelete, modifier = Modifier.size(32.dp)) {
                        Icon(Icons.Default.Delete, contentDescription = "Delete",
                            tint = Color(0xFFF44336), modifier = Modifier.size(18.dp))
                    }
                }
            }
        }
